...
import static com.print3d.chuk.TouchView.shapeRecord;
import static com.print3d.chuk.TouchView.shapesForColor;
...
public class DesignActivity extends AppCompatActivity {
    ...
    public static Button delete, done, cancel, undo, printStack;
    ...
    private Button next, back, continueForPayment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        printStack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                Log.e("**********","**********");
                for(String currentStack: stack){
                    Log.e("currentStack", ""+currentStack);
                }
                Log.e("**********","**********");
            }
                ...
                switch (actionType){
                    ...
                    case "touch":
                        ...
                        for(int i=0;i<TouchView.shapeRecord.size();i++){
                            if(shapeRecord.get(i) == shapeToUndo){
                                locations.add(i);
                            }
                        }
                        if(locations.size() > 0){
                    ...
                    case "rotate":
                        ...
                        if(rLocations.size() > 0 ) {
                            int lastRLocation = rLocations.size() - 1;
            ...
            public void onClick(View view) {
                ...
                if (currentNumText.getText().equals("T")) {
                    ...
                    if (!TouchView.shapes.isEmpty()) {
                        ...
                        shapesForColor.remove(TouchView.CURRENT_SHAPE);
...
//        touchView.textPaint.setColor(Color.parseColor(textColor));
    ...
    public void init(){
        ...
        printStack = (Button)findViewById(R.id.print_stack);
